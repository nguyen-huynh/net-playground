namespace OT.VVAExport.VVAPresentation
{
    ...
    {
        private SlideMasterPart CreateSlideMasterPart(SlideLayoutPart slideLayoutPart, string slideMasterId = null)
        {
            slideMasterId = slideMasterId ?? this.LastRelationshipIdOf<SlideMasterId>();
            SlideMasterPart slideMasterPart = slideLayoutPart.AddNewPart<SlideMasterPart>(slideMasterId);
