    ...
    public static class ShapeBuilder
    {
        ...
        public static ShapeStyle AppendDefaultShapeStyle<T>(this T element, string fontColor = null) where T : Shape
        {
            ...
            var result = new ShapeStyle(
                ...
                new FontReference(!string.IsNullOrEmpty(fontColor) ? new RgbColorModelHex { Val = fontColor } : new SchemeColor { Val = SchemeColorValues.Dark1 }) { Index = FontCollectionIndexValues.Minor }
                );
            element.Append(result);
            return result;
        }
            ...
            if (!string.IsNullOrEmpty(text))
            {
                paragraph.Append(new Run(
                    new RunProperties(
                        ...
                        new SolidFill(!string.IsNullOrEmpty(fontColor) ? new RgbColorModelHex { Val = fontColor } : new SchemeColor { Val = SchemeColorValues.Dark1 }),
